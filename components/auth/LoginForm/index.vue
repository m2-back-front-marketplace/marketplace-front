    ...
    <form class="form-card" @submit.prevent="onSubmit">
      ...
      <div class="input-group">
        <InputGroup>
          ...
          <InputText v-model="password" placeholder="Mot de passe" type="password" required />
        </InputGroup>
      </div>
  
      <Button class="button" :label="loading ? 'Connexion…' : 'Connexion'" :disabled="loading" type="submit" />
